...
Game.appLoginEditScreen.prototype = {
	...
	create: function (game) {
		...
		_this.basePath = cordova.file.externalRootDirectory + "Android/data/com.Akshara.TMBBplusplus/Files/Download/.gameFilesBB++V10_2/www/";

		_this.fullSize = 126710553;

		_this.zipFiles = [["Assets1.zip", 565373], ["Assets2.zip", 25572815], ["Assets4.zip", 66105124], ["questionSounds.zip", 30783494], ["sounds.zip", 3683747]];
		//30,783,494 + 95927059
		// //_this.basePath = cordova.file.externalRootDirectory+"Android/data/com.akshara.easymath/Files/Download/.gameFilesBBV5_0_5/www/";//39,766,797
		...
		if (_this.user.language == "English") {
			_this.fileCheck = [
				[_this.basePath + "questionSounds/ALAS-01-G6/English", _this.user.language + "/questionSounds.zip"],//ENG
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/ALAS-01-G6/HIN", _this.user.language + "/questionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user.language ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
		...
		// }
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/ALAS-01-G6/MAR", "MAR" + "/questionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user.language ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
		...
		// }
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/ALAS-01-G6/TM", "TM" + "/questionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user.language ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
	...
	checkIfAllAssetsPresent: function () {
		if (_this.counter < _this.fileCheck.length) {
			...
			window.baseUrl = cordova.file.externalRootDirectory + "Android/data/com.akshara.TMBBplusplus/Files/Download/.gameFilesBB++V10_2/www/";//cordova.file.externalDataDirectory + 
		...
		if (navigator.connection.type != "none" && navigator.connection.type != "unknown" && navigator.connection.type != null && navigator.connection.type != "undefined") {
			...
			fileTransfer.onprogress = function (progressEvent) {
				if (progressEvent.lengthComputable) {
					...
					if (filename == "TM" + "/questionSounds.zip")
