...
Game.grade7Algebra.prototype={
	...
	// 	},_this);
		...
		// _this.grade7OperationsGroup.add(_this.ALP_1_Screen);
		// _this.grade7OperationsGroup.add(_this.bgGraphicAlg8);
		// _this.grade7OperationsGroup.add(_this.ALP_1_ScreenTxt);

		// _this.grade7OperationsGroup.add(_this.ALP_2_Screen);
		// _this.grade7OperationsGroup.add(_this.bgGraphicAlg9);
		// _this.grade7OperationsGroup.add(_this.ALP_2_ScreenTxt);

		// _this.grade7OperationsGroup.add(_this.ALMAZE_1_Screen);
		// _this.grade7OperationsGroup.add(_this.bgGraphicAlg10);
		// _this.grade7OperationsGroup.add(_this.ALMAZE_1_ScreenTxt);

		// _this.grade7OperationsGroup.add(_this.ALMEM_1_Screen);
		// _this.grade7OperationsGroup.add(_this.bgGraphicAlg11);
		// _this.grade7OperationsGroup.add(_this.ALMEM_1_ScreenTxt);
